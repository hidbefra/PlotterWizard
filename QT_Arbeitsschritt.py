...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.pushButton_Geometrie_Importieren.setGeometry(QtCore.QRect(30, 370, 81, 23))
        ...
        self.pushButton_Geometrie_anpassen.setGeometry(QtCore.QRect(300, 370, 131, 23))
        ...
        self.textBrowser_Geometrie.setGeometry(QtCore.QRect(30, 170, 401, 191))
        ...
        self.lineEdit_offset_X.setGeometry(QtCore.QRect(130, 460, 121, 20))
        self.lineEdit_offset_X.setObjectName("lineEdit_offset_X")
        self.label_3 = QtWidgets.QLabel(Dialog)
        self.label_3.setGeometry(QtCore.QRect(30, 460, 91, 16))
        self.label_3.setObjectName("label_3")
        self.lineEdit_Rotation = QtWidgets.QLineEdit(Dialog)
        self.lineEdit_Rotation.setGeometry(QtCore.QRect(130, 520, 121, 20))
        self.lineEdit_Rotation.setText("")
        self.lineEdit_Rotation.setObjectName("lineEdit_Rotation")
        self.label_6 = QtWidgets.QLabel(Dialog)
        self.label_6.setGeometry(QtCore.QRect(30, 520, 91, 16))
        self.label_6.setObjectName("label_6")
        self.lineEdit_offset_Y = QtWidgets.QLineEdit(Dialog)
        self.lineEdit_offset_Y.setGeometry(QtCore.QRect(130, 490, 121, 20))
